...
// MessageV2 is the [github.com/bitquery/protobuf-sql/proto.Message] type used by the
// current [github.com/bitquery/protobuf-sql] module, adding support for reflection.
