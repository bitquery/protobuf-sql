...
[![Go Reference](https://pkg.go.dev/badge/github.com/bitquery/protobuf-sql.svg)](https://pkg.go.dev/github.com/bitquery/protobuf-sql)
...
*   Code generator: The
    [`protoc-gen-go`](https://pkg.go.dev/github.com/bitquery/protobuf-sql/cmd/protoc-gen-go)
...
*   Runtime library: The
    [`protobuf`](https://pkg.go.dev/mod/github.com/bitquery/protobuf-sql) module
    ...
    [define what a message is](https://pkg.go.dev/github.com/bitquery/protobuf-sql/reflect/protoreflect)
    and functionality to serialize message in various formats (e.g.,
    [wire](https://pkg.go.dev/github.com/bitquery/protobuf-sql/proto),
    [JSON](https://pkg.go.dev/github.com/bitquery/protobuf-sql/encoding/protojson),
    and
    [text](https://pkg.go.dev/github.com/bitquery/protobuf-sql/encoding/prototext)).
...
implemented by the
[`github.com/bitquery/protobuf-sql`](https://pkg.go.dev/mod/github.com/bitquery/protobuf-sql)
...
*   [`proto`](https://pkg.go.dev/github.com/bitquery/protobuf-sql/proto): Package
...
*   [`encoding/protojson`](https://pkg.go.dev/github.com/bitquery/protobuf-sql/encoding/protojson):
    Package `protojson` serializes protobuf messages as JSON.
*   [`encoding/prototext`](https://pkg.go.dev/github.com/bitquery/protobuf-sql/encoding/prototext):
    Package `prototext` serializes protobuf messages as the text format.
*   [`encoding/protowire`](https://pkg.go.dev/github.com/bitquery/protobuf-sql/encoding/protowire):
...
*   [`reflect/protoreflect`](https://pkg.go.dev/github.com/bitquery/protobuf-sql/reflect/protoreflect):
    Package `protoreflect` provides interfaces to dynamically manipulate
    protobuf messages.
*   [`reflect/protoregistry`](https://pkg.go.dev/github.com/bitquery/protobuf-sql/reflect/protoregistry):
    Package `protoregistry` provides data structures to register and lookup
    protobuf descriptor types.
*   [`reflect/protodesc`](https://pkg.go.dev/github.com/bitquery/protobuf-sql/reflect/protodesc):
    Package `protodesc` provides functionality for converting
    `descriptorpb.FileDescriptorProto` messages to/from the reflective
    `protoreflect.FileDescriptor`.
*   [`reflect/protopath`](https://pkg.go.dev/github.com/bitquery/protobuf-sql/reflect/protopath):
    Package `protopath` provides a representation of a sequence of
    protobuf reflection operations on a message.
*   [`reflect/protorange`](https://pkg.go.dev/github.com/bitquery/protobuf-sql/reflect/protorange):
    Package `protorange` provides functionality to traverse a protobuf message.
*   [`testing/protocmp`](https://pkg.go.dev/github.com/bitquery/protobuf-sql/testing/protocmp):
    Package `protocmp` provides protobuf specific options for the `cmp` package.
*   [`testing/protopack`](https://pkg.go.dev/github.com/bitquery/protobuf-sql/testing/protopack):
    Package `protopack` aids manual encoding and decoding of the wire format.
*   [`testing/prototest`](https://pkg.go.dev/github.com/bitquery/protobuf-sql/testing/prototest):
    Package `prototest` exercises the protobuf reflection implementation for
    concrete message types.
*   [`types/dynamicpb`](https://pkg.go.dev/github.com/bitquery/protobuf-sql/types/dynamicpb):
    Package `dynamicpb` creates protobuf messages at runtime from protobuf
    descriptors.
*   [`types/known/anypb`](https://pkg.go.dev/github.com/bitquery/protobuf-sql/types/known/anypb):
    Package `anypb` is the generated package for `google/protobuf/any.proto`.
*   [`types/known/timestamppb`](https://pkg.go.dev/github.com/bitquery/protobuf-sql/types/known/timestamppb):
    Package `timestamppb` is the generated package for
    `google/protobuf/timestamp.proto`.
*   [`types/known/durationpb`](https://pkg.go.dev/github.com/bitquery/protobuf-sql/types/known/durationpb):
    Package `durationpb` is the generated package for
    `google/protobuf/duration.proto`.
*   [`types/known/wrapperspb`](https://pkg.go.dev/github.com/bitquery/protobuf-sql/types/known/wrapperspb):
    Package `wrapperspb` is the generated package for
    `google/protobuf/wrappers.proto`.
*   [`types/known/structpb`](https://pkg.go.dev/github.com/bitquery/protobuf-sql/types/known/structpb):
    Package `structpb` is the generated package for
    `google/protobuf/struct.proto`.
*   [`types/known/fieldmaskpb`](https://pkg.go.dev/github.com/bitquery/protobuf-sql/types/known/fieldmaskpb):
    Package `fieldmaskpb` is the generated package for
    `google/protobuf/field_mask.proto`.
*   [`types/known/apipb`](https://pkg.go.dev/github.com/bitquery/protobuf-sql/types/known/apipb):
    Package `apipb` is the generated package for
    `google/protobuf/api.proto`.
*   [`types/known/typepb`](https://pkg.go.dev/github.com/bitquery/protobuf-sql/types/known/typepb):
    Package `typepb` is the generated package for
    `google/protobuf/type.proto`.
*   [`types/known/sourcecontextpb`](https://pkg.go.dev/github.com/bitquery/protobuf-sql/types/known/sourcecontextpb):
    Package `sourcecontextpb` is the generated package for
    `google/protobuf/source_context.proto`.
*   [`types/known/emptypb`](https://pkg.go.dev/github.com/bitquery/protobuf-sql/types/known/emptypb):
    Package `emptypb` is the generated package for
    `google/protobuf/empty.proto`.
*   [`types/descriptorpb`](https://pkg.go.dev/github.com/bitquery/protobuf-sql/types/descriptorpb):
    Package `descriptorpb` is the generated package for
    `google/protobuf/descriptor.proto`.
*   [`types/pluginpb`](https://pkg.go.dev/github.com/bitquery/protobuf-sql/types/pluginpb):
    Package `pluginpb` is the generated package for
    `google/protobuf/compiler/plugin.proto`.
*   [`compiler/protogen`](https://pkg.go.dev/github.com/bitquery/protobuf-sql/compiler/protogen):
    Package `protogen` provides support for writing protoc plugins.
*   [`cmd/protoc-gen-go`](https://pkg.go.dev/github.com/bitquery/protobuf-sql/cmd/protoc-gen-go):
...
*   **Internal changes**: We reserve the right to add, modify, and remove
    ...
    [`protoc-gen-go/internal_gengo`](https://pkg.go.dev/github.com/bitquery/protobuf-sql/cmd/protoc-gen-go/internal_gengo)
    package, the
    [`runtime/protoimpl`](https://pkg.go.dev/github.com/bitquery/protobuf-sql/runtime/protoimpl?tab=doc)
    package, and all packages under
    [`internal`](https://pkg.go.dev/github.com/bitquery/protobuf-sql/internal).
...
[protobuf module](https://pkg.go.dev/mod/github.com/bitquery/protobuf-sql). This
...
[`protoimpl.EnforceVersion`](https://pkg.go.dev/github.com/bitquery/protobuf-sql/runtime/protoimpl?tab=doc#EnforceVersion)
...
The new
[`proto.Message`](https://pkg.go.dev/github.com/bitquery/protobuf-sql/proto?tab=doc#Message)
interface contains a single `ProtoReflect` method that returns a
[`protoreflect.Message`](https://pkg.go.dev/github.com/bitquery/protobuf-sql/reflect/protoreflect?tab=doc#Message),
