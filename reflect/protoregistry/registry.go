...
//
//	go build -ldflags "-X github.com/bitquery/protobuf-sql/reflect/protoregistry.conflictPolicy=warn"
//
...
func (r *Files) checkGenProtoConflict(path string) {
	...
	currPath := "github.com/bitquery/protobuf-sql/types/known/" + pkgName
	panic(fmt.Sprintf(""+
